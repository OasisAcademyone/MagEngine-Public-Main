...
/// modified by magnumsrt for use in magengine actually thank you so much kade brother
...
class KeyBindMenu extends FlxSubState
{
	...
	{	
		...
		keyTextDisplay.setFormat(Paths.font("Funkin-Bold.otf"), 42, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
        ...
        infoText = new FlxText(-10, 580, 1280, "(Keybinds menu by Kade Dev, Escape to save, backspace to leave without saving)", 72);
